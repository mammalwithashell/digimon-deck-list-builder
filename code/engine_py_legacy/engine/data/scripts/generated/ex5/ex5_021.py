...
class EX5_021(CardScript):
    """EX5-021 Majiramon | Lv.5"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("EX5-021 Draw 1 and play 1 Digimon from hand on breeding area")
        ...
        # [Your Turn] When you use an Option card with a cost of 1 or more, gain 1 memory.
        effect1 = ICardEffect()
        effect1.set_effect_name("EX5-021 Memory +1")
        effect1.set_effect_description("[Your Turn] When you use an Option card with a cost of 1 or more, gain 1 memory.")
        effect1.set_max_count_per_turn(1)
        effect1.set_hash_string("Memory+1_EX5_021")
        ...
        effect2.set_hash_string("Memory+1_EX5_021")
