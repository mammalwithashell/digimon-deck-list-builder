...
class EX5_040(CardScript):
    """EX5-040 Kumbhiramon | Lv.5"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("EX5-040 Draw 1 and play 1 Digimon from hand on breeding area")
        ...
        effect1 = ICardEffect()
        effect1.set_effect_name("EX5-040 Draw 1")
        effect1.set_effect_description("[All Turns] [Once Per Turn] When an opponent's Digimon becomes suspended, <Draw 1> (Draw 1 card from your deck).")
        effect1.set_max_count_per_turn(1)
        effect1.set_hash_string("Draw1_EX5_040")
