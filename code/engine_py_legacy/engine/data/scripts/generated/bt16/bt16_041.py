...
class BT16_041(CardScript):
    """BT16-041 Stingmon | Lv.4"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        # Retaliation
        effect0 = ICardEffect()
        effect0.set_effect_name("BT16-041 Retaliation")
        ...
        effect1 = ICardEffect()
        effect1.set_effect_name("BT16-041 Alternate digivolution requirement")
        ...
        effect2.set_hash_string("Suspend_BT16-041")
