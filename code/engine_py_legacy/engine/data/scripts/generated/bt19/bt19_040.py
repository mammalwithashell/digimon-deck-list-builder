...
class BT19_040(CardScript):
    """BT19-040 Sakuyamon | Lv.6"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("BT19-040 Alternate digivolution requirement")
        effect0.set_effect_description("Alternate digivolution requirement")
        # Alternate digivolution: from [Sakuyamon: Maid Mode] for cost 1
        effect0._alt_digi_cost = 1
        effect0._alt_digi_name = "Sakuyamon: Maid Mode"

        def condition0(context: Dict[str, Any]) -> bool:
            permanent = card.permanent_of_this_card() if card else None
            if not (permanent and (permanent.contains_card_name('Sakuyamon: Maid Mode'))):
                return False
            return True
        ...
        effect2.set_hash_string("PlayToken_BT19_040")
