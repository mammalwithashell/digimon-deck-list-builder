...
class BT15_054(CardScript):
    """BT15-054 Rosemon (X Antibody) | Lv.6"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("BT15-054 Alternate digivolution requirement")
        effect0.set_effect_description("Alternate digivolution requirement")
        # Alternate digivolution: from [Rosemon] for cost 1
        effect0._alt_digi_cost = 1
        effect0._alt_digi_name = "Rosemon"

        def condition0(context: Dict[str, Any]) -> bool:
            permanent = card.permanent_of_this_card() if card else None
            if not (permanent and (permanent.contains_card_name('Rosemon'))):
                return False
            return True
        ...
        effect2.set_hash_string("Suspend1WhenPlayed_BT15_054")
        ...
        effect3.set_hash_string("Suspend1FromBreeding_BT15_054")
