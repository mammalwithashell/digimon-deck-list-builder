...
class BT22_070(CardScript):
    """BT22-070 DarkTyrannomon (X Antibody) | Lv.4"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("BT22-070 Alternate digivolution requirement")
        effect0.set_effect_description("Alternate digivolution requirement")
        # Alternate digivolution: Lv.4 for cost 0
        ...
        effect3.set_hash_string("Gain1_BT22-070")
