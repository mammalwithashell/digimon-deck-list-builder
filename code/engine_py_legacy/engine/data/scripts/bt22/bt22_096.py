...
class BT22_096(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        # Delay
        effect1 = ICardEffect()
        effect1.set_effect_name("BT22-096 Delay")
        ...
        def condition1(context: Dict[str, Any]) -> bool:
            ...
            if not (permanent and (permanent.contains_card_name('Yao Qinglan'))):
                return False
            return True
        ...
        effect3 = ICardEffect()
        effect3.set_effect_name("BT22-096 Security: Play this card")
