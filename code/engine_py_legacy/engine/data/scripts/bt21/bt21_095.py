...
class BT21_095(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        # Ignore Color Req
        effect0 = ICardEffect()
        effect0.set_effect_name("BT21-095 Ignore color requirements")
        ...
        # Vortex
        effect1 = ICardEffect()
        effect1.set_effect_name("BT21-095 Vortex")
        ...
        # Grant Skill
        effect2 = ICardEffect()
        effect2.set_effect_name("BT21-095 Your Digimon gain <Vortex>")
        ...
        effect3.set_effect_name("BT21-095 Play Card")
        effect3.set_effect_description("[Security] You may play 1 level 5 or lower Digimon with the [WG] trait from your hand without paying the cost.")
        ...
        def process3(ctx: Dict[str, Any]):
            ...
            def play_filter(c):
                ...
                if getattr(c, 'level', None) is None or c.level > 5:
                    return False
                if not (any('WG' in _t for _t in (getattr(c, 'card_traits', []) or []))):
                    return False
                return True
