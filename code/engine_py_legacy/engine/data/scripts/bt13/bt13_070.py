...
class BT13_070(CardScript):
    """BT13-070 RookChessmon | Lv.5"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("BT13-070 Alternate digivolution requirement")
        ...
        # Blocker
        effect1 = ICardEffect()
        effect1.set_effect_name("BT13-070 Blocker")
