...
class EX8_069(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        # Ignore Color Req
        effect0 = ICardEffect()
        effect0.set_effect_name("EX8-069 Ignore color requirements")
        ...
        # Alliance
        effect1 = ICardEffect()
        effect1.set_effect_name("EX8-069 Alliance")
        ...
        # Grant Skill
        effect2 = ICardEffect()
        effect2.set_effect_name("EX8-069 Your Digimons gain Alliance")
        ...
        def process3(ctx: Dict[str, Any]):
            ...
            def play_filter(c):
                ...
                if getattr(c, 'level', None) is None or c.level > 5:
                    return False
                if not (any('NSp' in _t for _t in (getattr(c, 'card_traits', []) or []))):
                    return False
                return True
