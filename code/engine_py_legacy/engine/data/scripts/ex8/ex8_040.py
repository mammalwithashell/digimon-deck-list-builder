...
class EX8_040(CardScript):
    """EX8-040 Kabuterimon | Lv.4"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("EX8-040 Alternate digivolution requirement")
        effect0.set_effect_description("Alternate digivolution requirement")
        # Alternate digivolution: Lv.3 with [NSp] trait for cost 2
        ...
        effect1.set_effect_name("EX8-040 Suspend 1 Digimon")
        ...
        effect2.set_effect_name("EX8-040 Suspend 1 Digimon")
        ...
        # DP modifier
        effect3 = ICardEffect()
        effect3.set_effect_name("EX8-040 DP modifier")
