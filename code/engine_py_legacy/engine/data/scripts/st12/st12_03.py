...
class ST12_03(CardScript):
    """ST12-03 Solarmon | Lv.3 Red Digimon | 3000 DP | Cost 3
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0.set_effect_name("ST12-03 Players can't reduce play costs")
        ...
        def process0(ctx: Dict[str, Any]):
            ...
            if not perm:
                return
            # Apply CANNOT_REDUCE_COST — aura-style effect on self
