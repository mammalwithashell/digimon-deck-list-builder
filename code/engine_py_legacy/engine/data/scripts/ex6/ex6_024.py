...
class EX6_024(CardScript):
    """EX6-024 Sagomon | Lv.5"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        # Effect
        effect0 = ICardEffect()
        effect0.set_effect_name("EX6-024 Effect")
        ...
        effect1.set_hash_string("SecurityAttack-1CantSuspend_EX6-024")
        ...
        def process1(ctx: Dict[str, Any]):
            """Action: Change Security Attack, Effect Immunity"""
        ...
        effect2.set_hash_string("SecurityAttack-1_EX6-024")
        ...
        effect4.set_hash_string("SecurityAttack-1_EX6-024")
