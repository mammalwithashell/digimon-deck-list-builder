...
class P_139(CardScript):
    """P-139 Leomon (X Antibody) | Lv.4"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("P-139 Alternate digivolution requirement")
        effect0.set_effect_description("Alternate digivolution requirement")
        # Alternate digivolution: alternate source for cost 0
        effect0._alt_digi_cost = 0
        effect0._alt_digi_name = "Leomon"
        ...
        effect1.set_effect_name("P-139 DP -3000")
        ...
        effect2.set_effect_name("P-139 DP -3000")
        ...
        # Blocker
        effect3 = ICardEffect()
        effect3.set_effect_name("P-139 Blocker")
        ...
        effect4.set_effect_name("P-139 Recovery +1 (Deck)")
        effect4.set_effect_description("[On Deletion] <Recovery +1 (Deck)>")
