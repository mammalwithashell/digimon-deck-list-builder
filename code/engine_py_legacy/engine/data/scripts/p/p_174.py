...
class P_174(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("P-174 Alternate digivolution requirement")
        ...
        # Jogress Condition
        effect1 = ICardEffect()
        effect1.set_effect_name("P-174 Jogress Condition")
        ...
        # Cost -4
        effect3 = ICardEffect()
        effect3.set_effect_name("P-174 Play Cost -4")
        ...
        # Blocker
        effect4 = ICardEffect()
        effect4.set_effect_name("P-174 Blocker")
