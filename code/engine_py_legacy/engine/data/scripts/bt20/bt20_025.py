...
class BT20_025(CardScript):
    """BT20-025 Wingdramon | Lv.5"""

    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        effects = []
        card.also_treated_as_names = ['Slayerdramon']

        # Factory effect: alt_digivolve_req
        # Alternate digivolution requirement
        effect0 = ICardEffect()
        effect0.set_effect_name("BT20-025 Alternate digivolution requirement")
        ...
        effect1.set_effect_name("BT20-025 Delete 1 Digimon with 6000 DP or less")
        ...
        effect2.set_effect_name("BT20-025 Delete 1 Digimon with 6000 DP or less")
        ...
        # Security Attack +1
        effect5 = ICardEffect()
        effect5.set_effect_name("BT20-025 Security Attack +1")
