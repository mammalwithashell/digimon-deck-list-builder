...
class BT20_010(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("BT20-010 Alternate digivolution requirement")
        ...
        effect1 = ICardEffect()
        effect1.set_effect_name("BT20-010 Change digivolution cost")
        ...
        # DP modifier
        effect2 = ICardEffect()
        effect2.set_effect_name("BT20-010 DP modifier")
