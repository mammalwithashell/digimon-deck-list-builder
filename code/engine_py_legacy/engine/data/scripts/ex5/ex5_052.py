...
class EX5_052(CardScript):
    """EX5-052 Makuramon | Lv.5"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0.set_effect_name("EX5-052 Draw 1 and play 1 Digimon from hand on breeding area")
        ...
        # Effect Immunity
        effect1 = ICardEffect()
        effect1.set_effect_name("EX5-052 Opponent's Tamer with play cost of 2 or less can't Suspend")
        ...
        # Blocker
        effect2 = ICardEffect()
        effect2.set_effect_name("EX5-052 Blocker")
