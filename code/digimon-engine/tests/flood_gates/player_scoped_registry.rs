...
fn player_has_returns_false_when_no_modifier_installed() {
    ...
    assert!(!r
        .game
        .modifiers
        .player_has(0, ModifierType::CannotGainMemoryByEffect));
    assert!(!r
        .game
        .modifiers
        .player_has(1, ModifierType::CannotGainMemoryByEffect));
}
...
fn end_of_turn_expiry_removes_player_modifier() {
    ...
    assert!(r
        .game
        .modifiers
        .player_has(1 - tp, ModifierType::CannotPlayDigimonByEffect));
...
fn until_leave_field_expiry_removes_modifier_when_source_permanent_leaves() {
    ...
    assert!(r
        .game
        .modifiers
        .player_has(1, ModifierType::CannotActivateMainEffects));
