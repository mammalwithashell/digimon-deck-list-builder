...
//!
//! This pass covers the inherited source-trash clause. The face-up
//! digivolution cost reduction is a separate unsupported before-digivolve
//! target-trait reduction shape.
