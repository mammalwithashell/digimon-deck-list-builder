//! EX10-028 Landramon
//!
//! This pass covers the inherited source-trash delete clause. The face-up
//! source-trash buff clause is a separate source-selection/passive buff pass.
...
#[test]
fn ex10_028_has_inherited_source_trash_delete_clause() {
    let runner = runner();
    let card = runner
        .compiled_card("EX10-028")
        .expect("EX10-028 compiled card present");
...
#[test]
fn ex10_028_source_trash_deletes_cost_four_or_less() {
    ...
    let source = runner.push_source(host, "EX10-028");
    ...
    runner
        .auto_resolve()
        .expect("EX10-028 delete target resolves");
