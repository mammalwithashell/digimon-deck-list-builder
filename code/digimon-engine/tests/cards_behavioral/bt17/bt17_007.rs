...
#[test]
fn bt17_007_has_inherited_dna_digivolve_alt_path_registration() {
    ...
    assert!(
        ...
        "BT17-007 must register an inherited end-of-your-turn DNA digivolve alt-path"
    );
}
...
fn bt17_007_clause_count_matches_card_text() {
    ...
    //   (1) the [Start of Your Main Phase] return-from-trash trigger
