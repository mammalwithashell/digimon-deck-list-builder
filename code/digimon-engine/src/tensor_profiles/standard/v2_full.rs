use crate::tensor_profiles::{TensorProfile, TensorSection, TensorSectionKind, TensorSlotLayout};
...
// `reserved` and changing `tensor_size`. The LAYOUT_HASH below is recomputed
// for the new layout.
pub const FEATURE_SCHEMA_VERSION: &str = "standard_full_v2.2";
pub const LAYOUT_HASH: &str =
    "sha256:4b1d0ef2a9c481c029bf267b3822c41711f8be58e6c3a2cd6fe44d77622e91a4";
...
pub const PERMANENT_SLOTS_SIZE: usize = v2_lite::PERMANENT_SLOTS_SIZE;
pub const OWN_HAND_SIZE: usize = v2_lite::OWN_HAND_SIZE;
pub const KNOWN_ZONE_SIZE: usize = v2_lite::KNOWN_ZONE_SIZE;
pub const DECISION_CONTEXT_SIZE: usize = v2_lite::DECISION_CONTEXT_SIZE;
pub const PENDING_CHOICE_SIZE: usize = v2_lite::PENDING_CHOICE_SIZE;
