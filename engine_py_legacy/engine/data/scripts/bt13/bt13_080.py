...
class BT13_080(CardScript):
    """BT13-080 ProtoGizmon | Lv.3"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0.set_hash_string("PlayCost-2_BT13_080")
        ...
        def process0(ctx: Dict[str, Any]):
            """Action: Cost -2, Play Card, Effect Immunity"""
        ...
        # Cost -2, Effect Immunity
        effect1 = ICardEffect()
        effect1.set_effect_name("BT13-080 Play Cost -2")
        effect1.set_effect_description("Cost -2, Effect Immunity")
