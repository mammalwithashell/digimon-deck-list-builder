...
class BT8_038(CardScript):
    """BT8-038 Magnamon | Lv.4"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("BT8-038 Alternate digivolution requirement")
        ...
        # Blocker
        effect1 = ICardEffect()
        effect1.set_effect_name("BT8-038 Blocker")
        ...
        # Armor Purge
        effect2 = ICardEffect()
        effect2.set_effect_name("BT8-038 Armor Purge")
