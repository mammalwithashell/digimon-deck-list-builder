...
class BT15_024(CardScript):
    """BT15-024 Garurumon | Lv.4"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("BT15-024 Alternate digivolution requirement")
        ...
        def process1(ctx: Dict[str, Any]):
            """Action: Draw 1, Cost -3, Play Card"""
            ...
            def play_filter(c):
                if not getattr(c, 'is_tamer', False):
                    return False
                if not (any('Matt Ishida' in _n for _n in getattr(c, 'card_names', []))):
                    return False
                return True
        ...
        effect2.set_hash_string("Draw1_BT15_024")
