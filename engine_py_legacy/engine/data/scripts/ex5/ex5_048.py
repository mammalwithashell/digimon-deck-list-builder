...
class EX5_048(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("EX5-048 Alternate digivolution requirement")
        effect0.set_effect_description("Alternate digivolution requirement")
        # Alternate digivolution: alternate source for cost 3
        effect0._alt_digi_cost = 3
        effect0._alt_digi_level = 4
        effect0._alt_digi_name = "Sukamon"
        ...
        effect1.set_effect_name("EX5-048 Opponent's 1 Digimon gains DP -3000 and must attack")
        effect1.set_effect_description("DP -3000")
        ...
        effect2.set_effect_name("EX5-048 Attack with this Digimon")
        ...
        effect3.set_effect_name("EX5-048 Opponent's 1 Digimon gains DP -3000 and must attack")
        effect3.set_effect_description("DP -3000")
        ...
        effect4.set_effect_name("EX5-048 Attack with this Digimon")
        ...
        effect5.set_hash_string("Reveal_EX5_048")
        ...
        def process5(ctx: Dict[str, Any]):
            ...
            def play_filter(c):
                ...
                if getattr(c, 'get_cost_itself', 0) > 3:
                    return False
                if not ('Black' in [col.name for col in getattr(c, 'card_colors', [])] or 'Yellow' in [col.name for col in getattr(c, 'card_colors', [])]):
                    return False
                return True
