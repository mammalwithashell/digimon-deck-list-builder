                        ...
                        <div className="border border-gray-800 rounded p-3 bg-gray-900 space-y-2">
                          ...
                          {batchDetail ? (
                            <>
                              ...
                              <div className="text-[11px] text-gray-400">pr_url={batchDetail.batch.pr_url ?? 'n/a'}</div>
                              <div className="text-[11px] text-emerald-300">
                                worked_cards ({workedItems.length}):{' '}
                                {workedItems.length > 0 ? workedItems.map((item) => item.card_id).join(', ') : 'none'}
                              </div>
