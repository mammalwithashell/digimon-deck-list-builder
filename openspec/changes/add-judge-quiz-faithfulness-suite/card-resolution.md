...
- Q2 → missing ENGINE PRIMITIVE (grant-triggered-effect-to-opponent); also blocks Q16, Q17.
...
- Q22 → ENGINE BUG (Digi-Egg routed to main deck; G-RETURN-TRASH-DIGI-EGG-ROUTING).
