...
- the selection `kind` is `CountCappedMultiSelect` and every valid action id falls within the trash action range `[TRASH_START, TRASH_END]` (130–179).
