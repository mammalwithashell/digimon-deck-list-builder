# dsl-inherited-substitute-trash Specification

## Purpose

Define the DSL clause that lets an inherited (digivolution-source) card
substitute "return this card to the bottom of the deck" for its would-be trash,
including how the substitution's cost is exposed as a player choice and resolved
atomically. This closes the gap `G-DSL-INHERITED-SUBSTITUTE-RETURN-TRASH` and
unblocks EX5-015 Clause C.
