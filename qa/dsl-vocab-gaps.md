...
- Card-authoring residual (NOT substrate): production `BT20-017.yaml` / `BT23-013.yaml` are later Track J card-authoring work (PR 2 / PR 3), needing the Atho/René/Por token (registered, Track J PR 1) and the Union hand+trash play primitive (`G-UNION-HAND-TRASH-NAME-EXCLUSION`, Task S2.2).
