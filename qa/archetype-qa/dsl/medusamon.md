...
- ST22-08 Offensive Plug-In V (Batch 11): BLOCKED (hybrid) — 2 active / 17 ignored. The Plug-In / Link card mechanic is entirely unavailable in the DSL. Seven distinct clauses were identified, all blocked:
  ...
  (3) [Security] add this card to hand: no DSL step for returning the played Option to hand; pattern from ex6_072_add_self_to_hand raw_rust exists but needs registration — new DSL gap G-ADD-OPTION-SELF-TO-HAND documented.
