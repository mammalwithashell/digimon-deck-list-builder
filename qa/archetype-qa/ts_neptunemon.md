...
| BT24-025 | Shellmon | FIXED | Fixed: digivolve targeted wrong perm; description said "blue" for end-of-turn |
...
| LM-028 | Blue Scramble | FIXED | Fixed: wrong descriptions, missing else branch, condition2 permanent check |
