...
### Inherited Effect
[Your Turn][Once Per Turn] When you use an Option card with a cost of 2 or more, ＜Draw 1＞. (Draw 1 card from your deck.)

## Official Q&A
- It can be activated after activating the used Option card's [Main] effect.

## Image
- C:\Users\james\Documents\DCGO_Application\Assets\Textures\Card\EX2-003.webp

_Source: https://world.digimoncard.com/cardlist/?search=true&card_no=EX2-003_