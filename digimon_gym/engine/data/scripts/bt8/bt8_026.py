...
class BT8_026(CardScript):
    """BT8-026 Halsemon | Lv.4"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("BT8-026 Alternate digivolution requirement")
        effect0.set_effect_description("Alternate digivolution requirement")
        # Alternate digivolution: alternate source for cost 2
        effect0._alt_digi_cost = 2
        effect0._alt_digi_name = "Hawkmon"
        ...
        # Armor Purge
        effect1 = ICardEffect()
        effect1.set_effect_name("BT8-026 Armor Purge")
