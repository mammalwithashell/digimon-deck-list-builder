...
class BT8_032(CardScript):
    """BT8-032 Imperialdramon Fighter Mode | Lv.6"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("BT8-032 Alternate digivolution requirement")
        effect0.set_effect_description("Alternate digivolution requirement")
        # Alternate digivolution: alternate source for cost 2
        effect0._alt_digi_cost = 2
        effect0._alt_digi_name = "Dragon Mode"
        ...
        effect2.set_hash_string("UnsuspendSuspend_BT8_032")
