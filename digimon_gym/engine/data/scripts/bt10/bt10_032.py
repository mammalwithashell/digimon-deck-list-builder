...
class BT10_032(CardScript):
    """BT10-032 Renamon | Lv.3"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0.set_effect_name("BT10-032 Reveal the top 4 cards of deck")
        effect0.set_effect_description("[On Play] Reveal the top 4 cards of your deck. Add 1 Option card with [Plug-In] in its name and 1 yellow Tamer card among them to your hand. Place the rest at the bottom of your deck in any order.")
        ...
        effect1.set_effect_name("BT10-032 DP -2000")
        ...
        effect1.set_hash_string("DP-2000_BT10_032")
