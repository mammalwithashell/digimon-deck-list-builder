...
class EX6_034(CardScript):
    """EX6-034 Antylamon | Lv.5"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("EX6-034 Alternate digivolution requirement")
        ...
        # Alliance
        effect1 = ICardEffect()
        effect1.set_effect_name("EX6-034 Alliance")
        ...
        effect2.set_hash_string("Play1Digimon_EX6_034")
        ...
        effect3.set_hash_string("EndofAttack_EX6_034")
