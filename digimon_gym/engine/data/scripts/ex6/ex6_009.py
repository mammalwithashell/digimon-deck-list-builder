...
class EX6_009(CardScript):
    """EX6-009 Duramon | Lv.5"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("EX6-009 Alternate digivolution requirement")
        ...
        effect2.set_hash_string("GainEffects_EX6_009")
        ...
        effect3.set_hash_string("TrashSecurity_BT11_014")
