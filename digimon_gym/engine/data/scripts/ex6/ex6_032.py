...
class EX6_032(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("EX6-032 Alternate digivolution requirement")
        ...
        effect1.set_effect_name("EX6-032 Suspend 1 Digimon")
        ...
        effect2.set_effect_name("EX6-032 DP -2000")
        ...
        effect2.set_hash_string("DP-2000_EX6_032")
