...
class BT16_044(CardScript):
    """BT16-044 Pistmon | Lv.5"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("BT16-044 Alternate digivolution requirement")
        ...
        effect1.set_effect_name("BT16-044 Suspend and/or gain memory")
        ...
        def process1(ctx: Dict[str, Any]):
            """Action: Gain 2 memory, Suspend, Gain Keyword Cannot Unsuspend"""
        ...
        effect2.set_effect_name("BT16-044 Suspend and/or gain memory")
        ...
        effect3.set_effect_name("BT16-044 Unsuspend this Digimon.")
        ...
        effect3.set_hash_string("Unsuspend_BT16_044")
