...
class BT16_090(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0.set_effect_name("BT16-090 Set memory to 3")
        ...
        effect1.set_hash_string("Play_ST16_090")
        ...
        def process1(ctx: Dict[str, Any]):
            ...
            if not (player and game):
                return
            def play_filter(c):
                if not (any('Big Ukkomon' in _n for _n in getattr(c, 'card_names', []))):
                    return False
                return True
        ...
        effect2 = ICardEffect()
        effect2.set_effect_name("BT16-090 Security: Play this card")
