...
class BT16_017(CardScript):
    """BT16-017 Veemon | Lv.3"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("BT16-017 Alternate digivolution requirement")
        ...
        # DP modifier
        effect2 = ICardEffect()
        effect2.set_effect_name("BT16-017 DP modifier")
