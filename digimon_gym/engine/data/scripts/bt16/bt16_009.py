...
class BT16_009(CardScript):
    """BT16-009 Lynxmon | Lv.4"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("BT16-009 Alternate digivolution requirement")
        ...
        # Armor Purge
        effect1 = ICardEffect()
        effect1.set_effect_name("BT16-009 Armor Purge")
        ...
        # Raid
        effect2 = ICardEffect()
        effect2.set_effect_name("BT16-009 Raid")
        ...
        effect3.set_effect_name("BT16-009 Opponent's Digimon gets -3000 DP for the turn")
