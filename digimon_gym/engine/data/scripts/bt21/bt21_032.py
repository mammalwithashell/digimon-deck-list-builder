...
class BT21_032(CardScript):
    """BT21-032 Veemon | Lv.3"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("BT21-032 Alternate digivolution requirement")
        effect0.set_effect_description("Alternate digivolution requirement")
        # Alternate digivolution: Lv.2 from [DemiVeemon] with [Hero] trait for cost 0
        effect0._alt_digi_cost = 0
        effect0._alt_digi_level = 2
        effect0._alt_digi_name = "DemiVeemon"
        effect0._alt_digi_trait = "Hero"

        def condition0(context: Dict[str, Any]) -> bool:
            permanent = card.permanent_of_this_card() if card else None
            if not (permanent and (permanent.contains_card_name('DemiVeemon'))):
                return False
            permanent = card.permanent_of_this_card() if card else None
        ...
        effect1 = ICardEffect()
        effect1.set_effect_name("BT21-032 Change digivolution cost")
        ...
        # DP modifier
        effect2 = ICardEffect()
        effect2.set_effect_name("BT21-032 DP modifier")
