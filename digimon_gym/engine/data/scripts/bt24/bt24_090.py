...
class BT24_090(CardScript):
    """Auto-transpiled from DCGO BT24_090.cs"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        # Alliance
        effect1 = ICardEffect()
        effect1.set_effect_name("BT24-090 Alliance")
        ...
        # Effect
        effect2 = ICardEffect()
        effect2.set_effect_name("BT24-090 Your Digimon gain <Alliance>")
        ...
        effect3 = ICardEffect()
        effect3.set_effect_name("BT24-090 Replace your bottom sec with this face-up card, play a [TS] Digimon for -3")
        effect3.set_effect_description("[Main] Add your bottom security card to the hand and place this card face up as the bottom security card. Then, you may play 1 blue or yellow [TS] trait Digimon card from your hand with the play cost reduced by 3.")
        ...
        effect4 = ICardEffect()
        effect4.set_effect_name("BT24-090 Play Card, Trash From Hand")
