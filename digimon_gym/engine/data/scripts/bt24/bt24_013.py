...
class BT24_013(CardScript):
    """Auto-transpiled from DCGO BT24_013.cs"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("BT24-013 If you have 5 or less cards, draw 1")
        ...
        # Effect
        effect1 = ICardEffect()
        effect1.set_effect_name("BT24-013 Effect")
        ...
        effect3 = ICardEffect()
        effect3.set_effect_name("BT24-013 When your hand is trashed from, digivolve")
        ...
        effect3.set_hash_string("BT24_013_YT_ESS")
