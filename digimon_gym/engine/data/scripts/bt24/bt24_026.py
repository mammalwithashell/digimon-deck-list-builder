...
class BT24_026(CardScript):
    """Auto-transpiled from DCGO BT24_026.cs"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("BT24-026 If you have 5 or less cards, draw 1")
        ...
        # Effect
        effect1 = ICardEffect()
        effect1.set_effect_name("BT24-026 Effect")
        ...
        effect3 = ICardEffect()
        effect3.set_effect_name("BT24-026 When your hand is trashed from, digivolve")
        ...
        effect3.set_hash_string("BT24_026_YT_ESS")
