...
class BT24_009(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("BT24-009 Alternate digivolution requirement")
        effect0.set_effect_description("Alternate digivolution requirement")
        # Alternate digivolution: Lv.2 from [Tsunomon] with [TS] trait for cost 0
        ...
        effect1 = ICardEffect()
        effect1.set_effect_name("BT24-009 By trashing 1 card, draw 2")
        effect1.set_effect_description("[On Play] By trashing 1 card with the [Demon], [Shaman] or [Titan] trait from your hand, <Draw 2>.")
        ...
        effect2 = ICardEffect()
        effect2.set_effect_name("BT24-009 When your hand is trashed from, digivolve")
        ...
        effect2.set_hash_string("BT24_009_YT_ESS")
