...
class P_109(CardScript):
    """P-109 Imperialdramon: Dragon Mode | Lv.6"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("P-109 Alternate digivolution requirement")
        effect0.set_effect_description("Alternate digivolution requirement")
        # Alternate digivolution: alternate source for cost 3
        effect0._alt_digi_cost = 3
        effect0._alt_digi_name = "Paildramon"
        ...
        # Blast Digivolve
        effect1 = ICardEffect()
        effect1.set_effect_name("P-109 Blast Digivolve")
        ...
        effect4.set_hash_string("Unsuspen_EX3_074")
