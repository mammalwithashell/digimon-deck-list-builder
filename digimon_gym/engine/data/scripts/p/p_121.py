...
class P_121(CardScript):
    """P-121 Armadillomon | Lv.3"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("P-121 Reveal the top 3 cards of deck")
        effect0.set_effect_description("[On Play] Reveal the top 3 cards of your deck. Add 1 black/yellow card with 2 or more colors and 1 Tamer card with [Cody Hida] among them to the hand. Return the rest to the bottom of the deck.")
        ...
        def process0(ctx: Dict[str, Any]):
            ...
            def reveal_filter_1(c):
                if not getattr(c, 'is_tamer', False):
                    return False
                if not (any('Cody Hida' in _n for _n in getattr(c, 'card_names', []))):
                    return False
                return True
        ...
        effect1 = ICardEffect()
        effect1.set_effect_name("P-121 DNA digivolve this Digimon")
