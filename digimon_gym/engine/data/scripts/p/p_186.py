...
class P_186(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        # Effect
        effect2 = ICardEffect()
        effect2.set_effect_name("P-186 Effect")
        ...
        effect3 = ICardEffect()
        effect3.set_effect_name("P-186 Delete a digimon, if you didnt <Recovery +1 (Deck)>")
        effect3.set_effect_description("[On Play] Delete 1 Digimon with 13000 DP or more. If this effect didn't delete, <Recovery +1 (Deck)> (Place the top card of your deck on top of your security stack).")
        ...
        effect4.set_effect_description("[When Digivolving] Delete 1 Digimon with 13000 DP or more. If this effect didn't delete, <Recovery +1 (Deck)> (Place the top card of your deck on top of your security stack).")
