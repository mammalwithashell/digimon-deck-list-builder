...
class P_036(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0.set_effect_name("P-036 Add To Hand, Reveal And Select")
        effect0.set_effect_description("[Main] Reveal the top 4 cards of your deck. Add 1 blue Digimon card among them to your hand. Place the remaining cards at the bottom of your deck in any order. Then, place this card in your battle area.")
        ...
        # Delay
        effect1 = ICardEffect()
        effect1.set_effect_name("P-036 Delay")
        ...
        effect2.set_effect_name("P-036 Memory +2")
