...
class P_208(CardScript):
    """P-208 Merukimon | Lv.6"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("P-208 Alternate digivolution requirement")
        ...
        # Execute
        effect1 = ICardEffect()
        effect1.set_effect_name("P-208 Execute")
        ...
        effect4.set_hash_string("P_208_WA")
