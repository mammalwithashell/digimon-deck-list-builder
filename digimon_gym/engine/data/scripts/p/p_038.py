...
class P_038(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("P-038 Add To Hand, Reveal And Select")
        effect0.set_effect_description("[Main] Reveal the top 4 cards of your deck. Add 1 green Digimon card among them to your hand. Place the remaining cards at the bottom of your deck in any order. Then, place this card in your battle area.")
        ...
        effect2 = ICardEffect()
        effect2.set_effect_name("P-038 Memory +2")
