...
class P_178(CardScript):
    """P-178 Sagittarimon | Lv.4"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("P-178 Alternate digivolution requirement")
        ...
        # Alternate digivolution requirement
        effect1 = ICardEffect()
        effect1.set_effect_name("P-178 Alternate digivolution requirement")
        effect1.set_effect_description("Alternate digivolution requirement")
        # Alternate digivolution: from [Veemon] for cost 2
        effect1._alt_digi_cost = 2
        effect1._alt_digi_name = "Veemon"
        ...
        effect2.set_effect_name("P-178 -3000 DP opponent digimon")
