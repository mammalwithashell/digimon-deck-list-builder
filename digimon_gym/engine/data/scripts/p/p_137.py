...
class P_137(CardScript):
    """P-137 Flamedramon | Lv.4"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("P-137 Alternate digivolution requirement")
        ...
        # Armor Purge
        effect1 = ICardEffect()
        effect1.set_effect_name("P-137 Armor Purge")
        ...
        effect3.set_hash_string("AddOpponentSecurityToHand_P_0137")
