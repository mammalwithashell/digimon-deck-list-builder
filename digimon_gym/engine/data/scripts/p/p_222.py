...
class P_222(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("P-222 Alternate digivolution requirement")
        ...
        # Cost -4
        effect2 = ICardEffect()
        effect2.set_effect_name("P-222 Play Cost -4")
        ...
        effect5.set_hash_string("P_222_AT")
