...
class BT15_058(CardScript):
    """BT15-058 Ginryumon | Lv.4"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        # Blocker
        effect0 = ICardEffect()
        effect0.set_effect_name("BT15-058 Blocker")
        ...
        effect1 = ICardEffect()
        effect1.set_effect_name("BT15-058 Alternate digivolution requirement")
        ...
        effect2.set_hash_string("suspend_BT15_058_inherited")
