...
class BT15_045(CardScript):
    """BT15-045 Palmon (X Antibody) | Lv.3"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("BT15-045 Alternate digivolution requirement")
        ...
        effect3.set_hash_string("Memory+1_BT15_045")
