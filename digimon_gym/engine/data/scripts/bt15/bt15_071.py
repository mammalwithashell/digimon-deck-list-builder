...
class BT15_071(CardScript):
    """BT15-071 Loogamon | Lv.3"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("BT15-071 Alternate digivolution requirement")
        ...
        effect2.set_hash_string("Meory+1_BT15_075")
