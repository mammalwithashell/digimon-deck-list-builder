...
class BT23_077(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        # --- Effect 2: [On Play] Delete 1 of your opponent's Digimon with a play cost of 4 or less ---
        effect2 = ICardEffect()
        ...
        def process2(ctx: Dict[str, Any]):
            ...
            def target_filter(p):
                return (p.is_digimon and p.top_card and
                        getattr(p.top_card, 'has_play_cost', True) and
        ...
        # --- Effect 3: [All Turns] When this Digimon suspends, <De-Digivolve 1> ---
        effect3 = ICardEffect()
