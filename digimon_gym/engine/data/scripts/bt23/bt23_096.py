...
class BT23_096(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect2 = ICardEffect()
        effect2.set_effect_name("BT23-096 <De-Digivolve 4> 1 digimon")
        ...
        effect3 = ICardEffect()
        effect3.set_effect_name("BT23-096 <De-Digivolve 4> 1 digimon, then place in battle area")
        effect3.set_effect_description("[Security] <De-Digivolve 4> 1 of your opponent's Digimon. Then, place this card in the battle area.")
