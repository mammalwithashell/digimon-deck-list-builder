...
class BT23_091(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect2 = ICardEffect()
        effect2.set_effect_name("BT23-091 Delete 1 digimon with lowest DP")
        effect2.set_effect_description("[Your Turn] When one of your [CS] trait Digimon attacks <Delay>, Delete 1 of your opponent's Digimon with the lowest DP.")
        ...
        effect3 = ICardEffect()
        effect3.set_effect_name("BT23-091 Delete 1 digimon with lowest DP, then place in battle area")
        effect3.set_effect_description("[Security] Delete 1 of your opponent's Digimon with the lowest DP. Then, place this card in the battle area.")
