...
class BT23_092(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect2 = ICardEffect()
        effect2.set_effect_name("BT23-092 1 digimon and tamer cant suspend until their turn ends")
        effect2.set_effect_description("[Your Turn] When one of your [CS] trait Digimon attacks <Delay>, Until your opponent's turn ends, 1 of their Digimon and 1 of their Tamers can't suspend.")
        ...
        effect3.set_effect_description("[Security] Until your opponent's turn ends, 1 of their Digimon and 1 of their Tamers can't suspend. Then, place this card in the battle area.")
