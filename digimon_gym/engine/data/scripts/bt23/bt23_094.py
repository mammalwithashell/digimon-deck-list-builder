...
class BT23_094(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect2 = ICardEffect()
        effect2.set_effect_name("BT23-094 1 digimon gains Sec Atk -1 and cant use [When Digivolving] & [When Attacking effects].")
        effect2.set_effect_description("When one of your [CS] trait Digimon attacks <Delay>. Until your opponent's turn ends, give 1 of their Digimon <Security A. -1> and it can't activate [When Digivolving] or [When Attacking] effects.")
        ...
        effect3 = ICardEffect()
        effect3.set_effect_name("BT23-094 1 digimon gains Sec Atk -1 and cant use [When Digivolving] & [When Attacking effects]. then place is battle area")
        effect3.set_effect_description("[Security] Until your opponent's turn ends, give 1 of their Digimon <Security A. -1> and it can't activate [When Digivolving] or [When Attacking] effects. Then, place this card in the battle area.")
