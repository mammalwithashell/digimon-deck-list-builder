...
class BT23_084(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("BT23-084 By suspend this tamer & bouncing 1 [Hudie] digimon to hand, play 1 level 3 [CS] digimon to empty breeding area")
        ...
        # Effect
        effect3 = ICardEffect()
        effect3.set_effect_name("BT23-084 Placeholder to mark as having inheritable")
