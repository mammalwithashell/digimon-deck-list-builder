...
class LM_034(CardScript):
    """LM-034 Blue Memory Boost! | Option (Blue, Cost 3)
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect1.set_effect_name("LM-034 Reveal top 3, add blue/red Digimon")
        effect1.set_effect_description(
            "[Main] Reveal the top 3 cards of your deck. Add 1 blue or red "
        ...
        def process1(ctx: Dict[str, Any]):
            ...
            def blue_or_red_digimon_filter(c):
                if not getattr(c, 'is_digimon', False):
                    return False
                colors = getattr(c, 'card_colors', []) or []
                color_names = [col.name for col in colors]
                return 'Blue' in color_names or 'Red' in color_names
            ...
            game.effect_reveal_and_select(
                player, 3,
                filter_fn=blue_or_red_digimon_filter,
        ...
        effect2 = ICardEffect()
        effect2.set_effect_name("LM-034 Delay")
        ...
        effect3.set_effect_name("LM-034 Delay: Gain 2 memory")
        ...
        effect4.set_effect_name("LM-034 Security: Place in battle area")
