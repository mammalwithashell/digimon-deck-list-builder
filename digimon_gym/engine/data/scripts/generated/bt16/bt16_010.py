...
class BT16_010(CardScript):
    """BT16-010 Helloogarmon | Lv.5"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("BT16-010 Alternate digivolution requirement")
        ...
        # Retaliation
        effect1 = ICardEffect()
        effect1.set_effect_name("BT16-010 Retaliation")
