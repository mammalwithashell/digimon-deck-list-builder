...
class BT22_057(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect1.set_effect_description("[When Digivolving] If you have 1 or fewer Tamers, you may play 1 [Arata Sanada] from your hand without paying the cost.")
        ...
        def process1(ctx: Dict[str, Any]):
            ...
            if not (player and game):
                return
            def play_filter(c):
                if not (any('Arata Sanada' in _n for _n in getattr(c, 'card_names', []))):
                    return False
                return True
