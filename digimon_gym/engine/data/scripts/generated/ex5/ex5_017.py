...
class EX5_017(CardScript):
    """EX5-017 Lekismon | Lv.4"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("EX5-017 Alternate digivolution requirement")
        ...
        # DP modifier
        effect3 = ICardEffect()
        effect3.set_effect_name("EX5-017 DP modifier")
