...
class EX5_071(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        # Ignore Color Req
        effect0 = ICardEffect()
        effect0.set_effect_name("EX5-071 Ignore color requirements")
        ...
        def process1(ctx: Dict[str, Any]):
            ...
            if not (player and game):
                return
            def reveal_filter(c):
                if not (any('Deva' in _t or 'Four Sovereigns' in _t or 'FourSovereigns' in _t for _t in (getattr(c, 'card_traits', []) or []))):
                    return False
                return True
        ...
        effect2 = ICardEffect()
        effect2.set_effect_name("EX5-071 Security: Play this card")
