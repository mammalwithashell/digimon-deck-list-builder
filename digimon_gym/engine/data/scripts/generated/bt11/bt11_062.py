...
class BT11_062(CardScript):
    """BT11-062 Agumon (X Antibody) | Lv.3"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("BT11-062 Alternate digivolution requirement")
        ...
        def process1(ctx: Dict[str, Any]):
            ...
            def reveal_filter_0(c):
                if not (any('X Antibody' in _n for _n in getattr(c, 'card_names', []))):
                    return False
                return True
