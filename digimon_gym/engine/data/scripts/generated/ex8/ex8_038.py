...
class EX8_038(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("EX8-038 Alternate digivolution requirement")
        ...
        effect1 = ICardEffect()
        effect1.set_effect_name("EX8-038 Suspend 1 Digimon")
        ...
        # Retaliation
        effect2 = ICardEffect()
        effect2.set_effect_name("EX8-038 Retaliation")
