...
class BT21_033(CardScript):
    """BT21-033 Floramon | Lv.3"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect1 = ICardEffect()
        effect1.set_effect_name("BT21-033 Reveal the top 3 cards of deck")
        effect1.set_effect_description("[On Play] Reveal the top 3 cards of your deck. Add 1 card with [Avian]/[Bird] in any of its traits and 1 card with the [WG] trait among them to the hand. Return the rest to the bottom of the deck.")
        ...
        # Jamming
        effect2 = ICardEffect()
        effect2.set_effect_name("BT21-033 Jamming")
