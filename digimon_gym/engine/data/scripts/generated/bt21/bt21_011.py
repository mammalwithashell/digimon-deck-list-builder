...
class BT21_011(CardScript):
    """BT21-011 Shoutmon | Lv.3"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("BT21-011 Alternate digivolution requirement")
        ...
        # Cost -1
        effect1 = ICardEffect()
        effect1.set_effect_name("BT21-011 Reduce the digivolution cost by 1")
        ...
        # Save
        effect2 = ICardEffect()
        effect2.set_effect_name("BT21-011 Save")
        ...
        # Rush
        effect3 = ICardEffect()
        effect3.set_effect_name("BT21-011 Rush")
