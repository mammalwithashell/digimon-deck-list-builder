...
class EX11_025(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect2 = ICardEffect()
        effect2.set_effect_name("EX11-025 Add top face down security to hand. Place [Royal Base] face up to bottom of security.")
        effect2.set_effect_description("[Start of Your Main Phase] Add your top face-down security card to the hand. Then, you may place 1 [Royal Base] trait Digimon card from your hand face up as the bottom security card.")
        ...
        # DP modifier
        effect3 = ICardEffect()
        effect3.set_effect_name("EX11-025 DP modifier")
