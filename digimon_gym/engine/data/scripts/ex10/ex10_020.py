    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        def _bounce_suspended(ctx: Dict[str, Any]):
            ...
            def on_bounce(target_perm):
                # Return to bottom of deck (not hand)
        ...
        effect4.set_effect_name("EX10-020 On Deletion: Place as bottom security")
        ...
        effect5.set_effect_name("EX10-020 Security: Play Dark Masters Lv5")
