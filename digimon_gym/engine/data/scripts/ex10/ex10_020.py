...
class EX10_020(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0.set_effect_name("EX10-020 Play for reduced cost of 5, delete at end of turn")
        ...
        effect1.set_effect_name("EX10-020 Delete the Digimon")
        ...
        effect2.set_effect_name("EX10-020 Return 1 suspended Digimon to the bottom of deck")
        effect2.set_effect_description("[On Play] Return 1 of your opponent's suspended Digimon to the bottom of the deck.")
        ...
        effect3.set_effect_name("EX10-020 Return 1 suspended Digimon to the bottom of deck")
        effect3.set_effect_description("[When Attacking] Return 1 of your opponent's suspended Digimon to the bottom of the deck.")
        ...
        effect4.set_effect_name("EX10-020 Place this Digimon face up as bottom security")
        effect4.set_effect_description("[On Deletion] If you have no green face-up security cards, place this Digimon face up as the bottom security card.")
        ...
        effect5.set_effect_name("EX10-020 Play Card")
