...
class EX10_070(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        # Ignore Color Req
        effect0 = ICardEffect()
        effect0.set_effect_name("EX10-070 Ignore color requirements")
        ...
        effect1 = ICardEffect()
        effect1.set_effect_name("EX10-070 Draw 1")
        ...
        # Delay
        effect2 = ICardEffect()
        effect2.set_effect_name("EX10-070 Delay")
        ...
        effect4 = ICardEffect()
        effect4.set_effect_name("EX10-070 place in battle area")
