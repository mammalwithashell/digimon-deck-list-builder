...
class EX10_043(CardScript):
    """EX10-043 Sakusimon | Lv.4"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("EX10-043 Alternate digivolution requirement")
        ...
        effect3.set_hash_string("GainMemory_EX10-043")
