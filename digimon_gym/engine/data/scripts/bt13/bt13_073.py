...
class BT13_073(CardScript):
    """BT13-073 QueenChessmon | Lv.6"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("BT13-073 Alternate digivolution requirement")
        ...
        # Blocker
        effect1 = ICardEffect()
        effect1.set_effect_name("BT13-073 Blocker")
