    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        def _link_maquinamon(ctx: Dict[str, Any]):
            ...
            def _do_link_from_digi():
                if not perm:
                    return
                # Let agent choose which digi card to link
                from ....game.constants import SEL_EFFECT_CHOICE_START
                from ....data.enums import GamePhase
                valid = []
                # Build valid indices for digi card candidates
            ...
            # If both sources available, let agent choose
        ...
        effect1.set_effect_description(
            "[When Moving] You may link 1 [Maquinamon] from your hand or "
            "this Digimon's digivolution cards to 1 of your Digimon without "
            "paying the cost.")
