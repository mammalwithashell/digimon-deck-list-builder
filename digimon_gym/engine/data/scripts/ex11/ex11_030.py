...
class EX11_030(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        # Alternate digivolution: with [Royal Base] trait for cost 2
        ...
        effect2 = ICardEffect()
        effect2.set_effect_name("EX11-030 Add To Hand, Destroy Security")
        effect2.set_effect_description("Add To Hand, Destroy Security")
        ...
        # DP modifier
        effect4 = ICardEffect()
        effect4.set_effect_name("EX11-030 DP modifier")
