...
class EX11_057(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        # Gain 1 memory (Tamer)
        effect0 = ICardEffect()
        effect0.set_effect_name("EX11-057 Gain 1 memory (Tamer)")
        ...
        effect1 = ICardEffect()
        effect1.set_effect_name("EX11-057 Trash any 1 sources of opponents digimon per your Ice-Snow Digimon.")
        ...
        effect2 = ICardEffect()
        effect2.set_effect_name("EX11-057 Suspend to Gain 1 Memory")
        effect2.set_effect_description("Gain 1 memory, Suspend")
        ...
        effect3 = ICardEffect()
        effect3.set_effect_name("EX11-057 Security: Play this card")
