...
class EX11_050(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect1.set_effect_name("EX11-050 Delete, Trash From Hand")
        ...
        effect2.set_effect_name("EX11-050 Delete, Trash From Hand")
        ...
        # Scapegoat
        effect3 = ICardEffect()
        effect3.set_effect_name("EX11-050 Scapegoat")
        ...
        # Grant Skill
        effect4 = ICardEffect()
        effect4.set_effect_name("EX11-050 Your [Dark Dragon]/[Evil Dragon] trait Digimon gain Scapegoat")
