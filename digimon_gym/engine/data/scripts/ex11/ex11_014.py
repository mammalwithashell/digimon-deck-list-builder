...
class EX11_014(CardScript):
    """EX11-014 Penguinmon | Lv.3"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("EX11-014 Alternate digivolution requirement")
        effect0.set_effect_description("Alternate digivolution requirement")
        # Alternate digivolution: from [Hiyarimon] for cost 0
        effect0._alt_digi_cost = 0
        effect0._alt_digi_name = "Hiyarimon"

        def condition0(context: Dict[str, Any]) -> bool:
            permanent = card.permanent_of_this_card() if card else None
            if not (permanent and (permanent.contains_card_name('Hiyarimon'))):
                return False
            return True
        ...
        def process1(ctx: Dict[str, Any]):
            ...
            def reveal_filter_0(c):
                if not (any('Suzune Kazuki' in _n for _n in getattr(c, 'card_names', []))):
                    return False
                return True
        ...
        # Jamming
        effect2 = ICardEffect()
        effect2.set_effect_name("EX11-014 Jamming")
