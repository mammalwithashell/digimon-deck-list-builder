...
class EX11_035(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        # Vortex
        effect0 = ICardEffect()
        effect0.set_effect_name("EX11-035 Vortex")
        ...
        # Blocker
        effect1 = ICardEffect()
        effect1.set_effect_name("EX11-035 Blocker")
        ...
        effect3.set_hash_string("EX11_035_AT")
        ...
        def process3(ctx: Dict[str, Any]):
            ...
            def play_filter(c):
                ...
                if not ('Green' in [col.name for col in getattr(c, 'card_colors', [])]):
                    return False
                if not (any('Avian' in _t or 'Bird' in _t for _t in (getattr(c, 'card_traits', []) or []))):
                    return False
                return True
