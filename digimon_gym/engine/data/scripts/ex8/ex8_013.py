...
class EX8_013(CardScript):
    """EX8-013 SkullMeramon | Lv.5"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("EX8-013 Alternate digivolution requirement")
        ...
        # Security Attack +1
        effect1 = ICardEffect()
        effect1.set_effect_name("EX8-013 Security Attack +1")
