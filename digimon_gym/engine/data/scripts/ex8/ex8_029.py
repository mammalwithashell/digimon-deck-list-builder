...
class EX8_029(CardScript):
    """EX8-029 Aegisdramon | Lv.7"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        # Jogress Condition
        effect0 = ICardEffect()
        effect0.set_effect_name("EX8-029 Jogress Condition")
        effect0.set_effect_description("Jogress Condition")

        effect = effect0  # alias for condition closure
        def condition0(context: Dict[str, Any]) -> bool:
            permanent = effect.effect_source_permanent if hasattr(effect, 'effect_source_permanent') else None
            if not (permanent and (permanent.contains_card_name('Plesiomon'))):
                return False
            return True
        ...
        # Jogress Condition
        effect1 = ICardEffect()
        effect1.set_effect_name("EX8-029 Jogress Condition")
        ...
        # Effect Immunity
        effect3 = ICardEffect()
        effect3.set_effect_name("EX8-029 Isn't affected by opponent's Digimon's effects")
        ...
        effect4 = ICardEffect()
        effect4.set_effect_name("EX8-029 [On Plays] can't activate")
        effect4.set_effect_description("Disable Effect, Effect Immunity")
