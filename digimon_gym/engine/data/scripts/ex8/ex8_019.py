...
class EX8_019(CardScript):
    """EX8-019 Penguinmon | Lv.3"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("EX8-019 Alternate digivolution requirement")
        effect0.set_effect_description("Alternate digivolution requirement")
        # Alternate digivolution: alternate source for cost 0
        effect0._alt_digi_cost = 0
        effect0._alt_digi_name = "Hiyarimon"
        ...
        effect1 = ICardEffect()
        effect1.set_effect_name("EX8-019 Change digivolution cost")
        ...
        effect2.set_effect_name("EX8-019 Security Attack -1")
        effect2.set_effect_description("[When Attacking] Give 1 of your opponent's Digimon <Security A. -1> until the end of their turn.")
