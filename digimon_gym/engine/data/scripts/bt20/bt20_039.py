...
class BT20_039(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("BT20-039 Alternate digivolution requirement")
        effect0.set_effect_description("Alternate digivolution requirement")
        # Alternate digivolution: Lv.3 with [ACCEL] trait for cost 2
        ...
        effect1.set_effect_name("BT20-039 Suspend 1 of your opponent's Digimon")
        ...
        effect2.set_effect_name("BT20-039 Suspend 1 of your opponent's Digimon")
