...
class BT20_080(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect1 = ICardEffect()
        effect1.set_effect_name("BT20-080 Play 1 Digimon from trash")
        effect1.set_effect_description("[When Digivolving] You may play 1 level 4 or lower [SoC] or [SEEKERS] trait Digimon from your trash without paying the cost.")
        ...
        effect2 = ICardEffect()
        effect2.set_effect_name("BT20-080 Activate effect, then attack")
        effect2.set_effect_description("[All Turns] When Tamer cards are placed in this Digimon's digivolution cards, activate 1 of this Digimon's [When Digivolving] effects. Then, 1 of your Digimon may attack a player.")
        ...
        effect3 = ICardEffect()
        effect3.set_effect_name("BT20-080 Trash opponent's top security")
        effect3.set_effect_description("[All Turns] [Once Per Turn] When any of your opponent's Digimon are deleted, if this Digimon has [Fenriloogamon] in its name, trash your opponent's top security card.")
        effect3.is_inherited_effect = True
        effect3.set_max_count_per_turn(1)
        effect3.set_hash_string("TrashSecurity_BT20-080")
