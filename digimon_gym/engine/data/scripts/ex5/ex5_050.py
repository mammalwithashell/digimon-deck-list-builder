...
class EX5_050(CardScript):
    """EX5-050 Sinduramon | Lv.5"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0.set_effect_name("EX5-050 Draw 1 and play 1 Digimon from hand on breeding area")
        ...
        # Decoy
        effect1 = ICardEffect()
        effect1.set_effect_name("EX5-050 Decoy")
        ...
        # Blocker
        effect2 = ICardEffect()
        effect2.set_effect_name("EX5-050 Blocker")
