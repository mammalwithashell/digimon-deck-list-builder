...
class EX5_011(CardScript):
    """EX5-011 Pajiramon | Lv.5"""
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("EX5-011 Draw 1 and play 1 Digimon from hand on breeding area")
        ...
        effect1 = ICardEffect()
        effect1.set_effect_name("EX5-011 Memory +1")
        effect1.set_effect_description("[On Deletion] If your opponent has a Tamer, gain 1 memory.")
        ...
        # Security Attack +1
        effect2 = ICardEffect()
        effect2.set_effect_name("EX5-011 Security Attack +1")
