...
class BT14_014(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect2.set_effect_description("[On Play] Delete 1 of your opponent's Digimon with 6000 DP or less.")
        ...
        effect3.set_effect_name("BT14-014 Delete 1 Digimon with 6000 DP or less")
        effect3.set_effect_description("[When Digivolving] Delete 1 of your opponent's Digimon with 6000 DP or less.")
