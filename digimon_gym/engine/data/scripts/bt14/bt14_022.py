...
class BT14_022(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        # [When Attacking] Trash any 1 digivolution card of 1 of your opponent's Digimon.
        # Then, return 1 of your opponent's level 5 or lower Digimon with no digivolution cards to the hand.
        effect0 = ICardEffect()
        effect0.set_effect_name("BT14-022 Trash digivolution card then return 1 Digimon to hand")
        ...
        def process0(ctx: Dict[str, Any]):
            ...
            # Step 1: Trash any 1 digivolution card of 1 of your opponent's Digimon.
            def can_trash_filter(p):
            ...
            game.effect_select_opponent_permanent(
                player, on_trash, filter_fn=can_trash_filter, is_optional=False
            )
