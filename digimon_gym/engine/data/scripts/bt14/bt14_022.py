...
class BT14_022(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0 = ICardEffect()
        effect0.set_effect_name("BT14-022 Trash digivolution card then return Digimon to hand")
        ...
        def process0(ctx: Dict[str, Any]):
            ...
            # Step 1: Trash any 1 digivolution card from 1 opponent Digimon.
            ...
            game.effect_select_opponent_permanent(
                player, on_bounce, filter_fn=can_bounce_target, is_optional=False
            )
