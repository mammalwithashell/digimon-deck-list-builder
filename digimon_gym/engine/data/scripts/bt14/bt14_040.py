...
class BT14_040(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        def process0(ctx: Dict[str, Any]):
            ...
            def tamer_filter(c):
                return getattr(c, 'card_kind', None) == 1

            game.effect_add_to_security_from_zone(
                player, 'hand', tamer_filter, count=1, is_optional=True, on_top=True
            )
