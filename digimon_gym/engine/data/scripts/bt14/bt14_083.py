...
class BT14_083(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        effect0.set_effect_description("[On Play] Trash 1 digivolution card of 1 of your opponent's Digimon.")
        ...
        def process0(ctx: Dict[str, Any]):
            ...
            def target_filter(target_perm):
                ...
                return owner is not None and owner != player and not getattr(target_perm, 'has_no_digivolution_cards', True)

            def on_target(target_perm):
                target_perm.trash_digivolution_cards(1)

            game.effect_select_opponent_permanent(player, on_target, filter_fn=target_filter, is_optional=False)
        ...
        effect1.set_effect_description("[Your Turn] When a card is trashed from under one of your opponent's Digimon, by suspending this Tamer, gain 1 memory.")
