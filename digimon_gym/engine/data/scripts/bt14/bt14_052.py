...
class BT14_052(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        # Keyword effect: Piercing
        effect0 = ICardEffect()
        effect0.set_effect_name("BT14-052 Piercing")
        effect0.set_effect_description("＜Piercing＞")
        effect0.has_piercing = True
        ...
        # Inherited effect: [Your Turn] While this Digimon has [Leomon] in its name, it gets +2000 DP.
        effect2 = ICardEffect()
        effect2.set_effect_name("BT14-052 Inherited +2000 DP with [Leomon]")
