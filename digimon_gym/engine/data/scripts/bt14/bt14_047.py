...
class BT14_047(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        # [On Play] Suspend 1 of your opponent's Digimon. During your opponent's next unsuspend phase,
        # all of your opponent's Digimon with 5000 DP or less don't unsuspend.
        effect0 = ICardEffect()
        ...
        def process0(ctx: Dict[str, Any]):
            ...
            # Suspend any 1 opponent Digimon.
            game.effect_select_opponent_permanent(
                player, on_suspend, is_optional=False)

            # Apply delayed next-unsuspend-phase lock (engine handles 5000 DP-or-less scope for this keyword).
            if perm:
        ...
        # Timing: EffectTiming.OnEnterFieldAnyone
        # [When Digivolving] Suspend 1 of your opponent's Digimon. During your opponent's next unsuspend phase,
        # all of your opponent's Digimon with 5000 DP or less don't unsuspend.
        effect1 = ICardEffect()
