...
class BT14_049(CardScript):
    ...
    def get_card_effects(self, card: 'CardSource') -> List['ICardEffect']:
        ...
        def process1(ctx: Dict[str, Any]):
            ...
            # Suspend 1 of opponent's Digimon (no DP restriction)
            ...
            # Then, you may return 1 of opponent's suspended Digimon with 5000 DP or less to bottom of deck
            def bounce_filter(p):
            ...
            def on_bottom_deck(target_perm):
                ...
                if enemy:
                    enemy.bounce_permanent_to_bottom_deck(target_perm)

            game.effect_select_opponent_permanent(
                player, on_bottom_deck, filter_fn=bounce_filter, is_optional=True
            )
