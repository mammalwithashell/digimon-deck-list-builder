...
Examples:
  python .codex/skills/digimon-card-lookup/scripts/resolve_cards.py BT17-001
  python .codex/skills/digimon-card-lookup/scripts/resolve_cards.py Wormmon
  python .codex/skills/digimon-card-lookup/scripts/resolve_cards.py BT24-102 --editions
  python .codex/skills/digimon-card-lookup/scripts/resolve_cards.py "Xros Heart" --type archetype
  python .codex/skills/digimon-card-lookup/scripts/resolve_cards.py Wormmon --paths-only
  python .codex/skills/digimon-card-lookup/scripts/resolve_cards.py Wormmon --json
"""
