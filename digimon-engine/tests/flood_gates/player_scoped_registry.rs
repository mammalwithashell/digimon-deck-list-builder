...
fn player_has_returns_true_after_install() {
    ...
    r.game.modifiers.add_player_modifier(1, PlayerModifierEntry {
...
fn end_of_turn_expiry_removes_player_modifier() {
    ...
    r.game.modifiers.add_player_modifier(1 - tp, PlayerModifierEntry {
...
fn end_of_opponents_turn_expiry_discriminates_by_source_player() {
    ...
    r.game.modifiers.add_player_modifier(1, PlayerModifierEntry {
        ...
        value: 0,
        expiry: Expiry::EndOfOpponentsTurn,
        source_permanent: None,
        source_player: 0,
    });
...
fn multiple_player_modifiers_coexist() {
    ...
    r.game.modifiers.add_player_modifier(1, PlayerModifierEntry {
        modifier: ModifierType::CannotPlayDigimonByEffect,
        value: 0, expiry: Expiry::Permanent, source_permanent: None, source_player: 0,
    });
    r.game.modifiers.add_player_modifier(1, PlayerModifierEntry {
        modifier: ModifierType::CannotGainMemoryByEffect,
        value: 0, expiry: Expiry::Permanent, source_permanent: None, source_player: 0,
