...
// ---------------------------------------------------------------------------
// RealCardDataAdapter (Task 6) appended below `cross_check`.
...
// ---------------------------------------------------------------------------
// RealCardDataAdapter — Phase 1a Task 6
// ---------------------------------------------------------------------------

use std::path::Path as StdPath;

/// Real `CardDataDb` adapter that reads `cards.json` via the engine's existing
/// `CardData` parser. Maps engine-side enum values to their DSL counterparts
/// at lookup time.
