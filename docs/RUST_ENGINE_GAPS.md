...
cost reduction" + "Cross-card effect re-firing (source-card variant)" (BT15-102 already listed).
...
- **G-DSL-PLACE-AS-TOP-SOURCE** (qa/dsl-vocab-gaps.md) — add EX9-074 Kimeramon (place trash card as TOP source; behaviorally inert for its colour-count → ship PARTIAL with note).
