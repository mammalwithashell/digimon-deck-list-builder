...
- **Card(s):** BT22-055 Recomon, BT22-058 Dreammon, BT22-075 Fakemon, BT24-053 Protecmon, and the broader BT22/BT24 Appmon pool (every card with `Link Requirements [Link] [Appmon] trait: Cost N`).
