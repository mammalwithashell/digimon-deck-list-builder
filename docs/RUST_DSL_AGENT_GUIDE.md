...
<!-- vocab-structural-sha: 1212c5be9731e4e3f46adf2154d4ce52debb01cce70350f56ae99742ac9f7eb9 -->
...
Complete, enum-derived index of every authoring primitive: **165 step verbs**, **188 predicates**, **60 timings**, **12 declarative kinds**. `uses` = card YAMLs referencing the key; `tag` flags `unused` (0 uses) or `rare` (1–2) vocabulary; `fixture` is a real card to open.
