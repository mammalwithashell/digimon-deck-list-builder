...
<!-- vocab-structural-sha: 746a07c2fe9c32b48e824e235814a620fdc2ddf7bd810554ce470619d262674d -->
...
Complete, enum-derived index of every authoring primitive: **155 step verbs**, **160 predicates**, **56 timings**, **12 declarative kinds**. `uses` = card YAMLs referencing the key; `tag` flags `unused` (0 uses) or `rare` (1–2) vocabulary; `fixture` is a real card to open.
...
| `optional` | `OptionalStep` | 410 |  | `_examples/BT11-042.yaml` |  |
...
| `place_permanent_on_security` | `PlacePermanentOnSecurityReplacementArgs` | 7 |  | `bt23/BT23-102.yaml` |  |
