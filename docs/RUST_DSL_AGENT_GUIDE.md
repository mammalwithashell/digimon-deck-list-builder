...
<!-- vocab-structural-sha: ef866977c33a09c395425472d7f2c007d5d6eae8d236dafff51b38072d17a072 -->
...
Complete, enum-derived index of every authoring primitive: **163 step verbs**, **185 predicates**, **59 timings**, **12 declarative kinds**. `uses` = card YAMLs referencing the key; `tag` flags `unused` (0 uses) or `rare` (1–2) vocabulary; `fixture` is a real card to open.
...
| `if` | `IfStep` | 238 |  | `_examples/BT17-015.yaml` |  |
| `optional` | `OptionalStep` | 519 |  | `_examples/BT11-042.yaml` |  |
...
| `de_digivolve` | `DeDigivolveArgs` | 42 |  | `ad1/AD1-009.yaml` |  |
| `delete_bound_permanents` | `DeleteBoundPermanentsArgs` | 4 |  | `bt17/BT17-018.yaml` |  |
| `delete_permanent` | `TargetArg` | 152 |  | `_examples/BT17-015.yaml` |  |
...
| `draw` | `DrawArgs` | 117 |  | `_examples/TST_DNA_TRIGGER.yaml` |  |
...
| `trash_from_hand_by_index` | `IndexedMoveArgs` | 54 |  | `ad1/AD1-002.yaml` |  |
...
| `add_modifier` | `AddModifierArgs` | 77 |  | `_examples/BT13-060.yaml` |  |
...
| `grant_keyword` | `GrantKeywordArgs` | 79 |  | `_examples/BT11-042.yaml` |  |
...
| `place_remainder_on_deck` | `PlaceRemainderArgs` | 79 |  | `_examples/EX11-027.yaml` |  |
...
| key | arg | uses | tag | fixture | description |
|-----|-----|------|-----|---------|-------------|
| `add_to_hand_from_reveal` | `HandleMoveArgs` | 83 |  | `_examples/EX11-027.yaml` |  |
...
| `reveal_top_deck` | `RevealArgs` | 98 |  | `_examples/BT13-007.yaml` |  |
| `select_reveal` | `SelectZoneArgs` | 38 |  | `_examples/EX11-027.yaml` |  |
| `select_reveal_buckets` | `SelectRevealBucketsArgs` | 52 |  | `bt11/BT11-061.yaml` |  |
...
| `select_effect_choice` | `SelectEffectChoiceArgs` | 65 |  | `_examples/BT17-015.yaml` |  |
| `select_hand` | `SelectZoneArgs` | 239 |  | `_examples/BT17-015.yaml` |  |
...
| `select_opponent_permanent` | `SelectFieldArgs` | 282 |  | `_examples/BT12-112.yaml` |  |
...
| `select_own_permanent` | `SelectFieldArgs` | 188 |  | `_examples/BT12-112.yaml` |  |
| `select_trash` | `SelectZoneArgs` | 93 |  | `_examples/BT18-019.yaml` |  |
| `select_union_zone` | `SelectUnionArgs` | 49 |  | `ad1/AD1-002.yaml` |  |

#### Stack / Source — 17 (1 unused)

| key | arg | uses | tag | fixture | description |
|-----|-----|------|-----|---------|-------------|
| `place_as_bottom_source` | `PlaceAsBottomSourceArgs` | 56 |  | `_examples/BT13-007.yaml` |  |
...
| `select_opponent_sources` | `SelectOpponentSourcesArgs` | 10 |  | `bt16/BT16-085.yaml` |  |
| `select_own_sources` | `SelectOwnSourcesArgs` | 22 |  | `bt12/BT12-031.yaml` |  |
| `trash_all_sources` | `TargetArg` | 2 | rare | `bt17/BT17-077.yaml` |  |
| `trash_bottom_sources` | `TrashBottomSourcesArgs` | 8 |  | `bt25/BT25-026.yaml` |  |
| `trash_selected_sources` | `TrashSelectedSourcesArgs` | 24 |  | `bt16/BT16-085.yaml` |  |
...
| `any_permanent` | `ExistentialPredicate?` | 198 |  | `_examples/BT11-042.yaml` |  |
| `color_matches_any_field_digimon` | `PlayerRefSelector?` | 1 | rare | `p/P-206.yaml` |  |
| `count_gte` | `CountAggregate?` | 107 |  | `_examples/EX11-027.yaml` |  |
...
| `binding_present` | `str?` | 80 |  | `ad1/AD1-002.yaml` |  |
...
| `equals` | `[]?` | 66 |  | `_examples/BT17-015.yaml` |  |
...
| key | arg | uses | tag | fixture | description |
|-----|-----|------|-----|---------|-------------|
| `all_of` | `[PredicateSpec]` | 591 |  | `_examples/BT11-042.yaml` |  |
| `any_of` | `[PredicateSpec]` | 349 |  | `_examples/BT11-042.yaml` |  |
| `none_of` | `[PredicateSpec]` | 44 |  | `bt13/BT13-019.yaml` |  |
| `not` | `PredicateSpec?` | 10 |  | `ad1/AD1-017.yaml` |  |
| `other` | `bool?` | 27 |  | `ad1/AD1-012.yaml` |  |
| `owner` | `PlayerRef?` | 55 |  | `_examples/BT11-042.yaml` |  |
| `zone` | `[Zone]` | 373 |  | `_examples/BT11-042.yaml` |  |
...
| `your_turn` | `bool?` | 223 |  | `_examples/BT11-042.yaml` |  |
...
| `color_is` | `ColorSpec?` | 432 |  | `_examples/BT11-042.yaml` |  |
...
| `level_lte` | `DpConstraint?` | 78 |  | `ad1/AD1-014.yaml` |  |
...
| `name_in` | `[str]?` | 13 |  | `ad1/AD1-005.yaml` |  |
| `name_is` | `str?` | 117 |  | `_examples/BT12-112.yaml` |  |
...
| `play_cost_lte` | `DpConstraint?` | 43 |  | `ad1/AD1-018.yaml` |  |
...
| `trait_has` | `str?` | 452 |  | `_examples/BT11-042.yaml` |  |
...
| `replacement_subject_is_mine` | `bool?` | 40 |  | `bt13/BT13-075.yaml` |  |
...
| `start_of_your_main_phase` | 67 |  |
| `start_of_your_turn` | 34 |  |
