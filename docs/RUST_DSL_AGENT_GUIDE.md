...
<!-- vocab-structural-sha: f579ab55019bc3f4a9ec5121369a7e807b7b3007822f6f59fe1051b1f8635af8 -->
...
Complete, enum-derived index of every authoring primitive: **148 step verbs**, **160 predicates**, **56 timings**, **12 declarative kinds**. `uses` = card YAMLs referencing the key; `tag` flags `unused` (0 uses) or `rare` (1–2) vocabulary; `fixture` is a real card to open.
