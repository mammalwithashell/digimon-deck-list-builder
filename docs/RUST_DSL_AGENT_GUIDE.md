...
<!-- vocab-structural-sha: 5db16d63766f8a9c697199281269513710a7408fa0fb3876d84ed6658aeb8b0b -->
...
Complete, enum-derived index of every authoring primitive: **149 step verbs**, **160 predicates**, **56 timings**, **12 declarative kinds**. `uses` = card YAMLs referencing the key; `tag` flags `unused` (0 uses) or `rare` (1–2) vocabulary; `fixture` is a real card to open.
...
| `if` | `IfStep` | 182 |  | `_examples/BT15-003.yaml` |  |
...
| `relink_self_to_own_digimon` | `RelinkSelfToOwnDigimonArgs` | 0 | unused | — | `relink_self_to_own_digimon:` â€” move the effect's own standing permanent to become a link card on a chosen OTHER own Digimon (EX11-027 "link this Digimon to 1 of your other Digimon"). Over `absorb_standing_digimon_as_link`. |
...
| `select_effect_choice` | `SelectEffectChoiceArgs` | 57 |  | `_examples/BT15-003.yaml` |  |
...
| `count_gte` | `CountAggregate?` | 77 |  | `ad1/AD1-017.yaml` |  |
...
| `equals` | `[]?` | 57 |  | `_examples/BT15-003.yaml` |  |
...
| `any_of` | `[PredicateSpec]` | 278 |  | `_examples/BT11-042.yaml` |  |
...
| `zone` | `[Zone]` | 307 |  | `_examples/BT11-042.yaml` |  |

#### Context / global — 19 (3 unused)
...
| `color_is` | `ColorSpec?` | 331 |  | `_examples/BT11-042.yaml` |  |
...
| `level_eq` | `i32?` | 430 |  | `_examples/AD1-025.yaml` |  |
...
| `name_contains` | `str?` | 136 |  | `_examples/AD1-025.yaml` |  |
| `name_in` | `[str]?` | 11 |  | `ad1/AD1-005.yaml` |  |
| `name_is` | `str?` | 80 |  | `_examples/BT12-112.yaml` |  |
...
| `trait_has` | `str?` | 338 |  | `_examples/BT11-042.yaml` |  |
