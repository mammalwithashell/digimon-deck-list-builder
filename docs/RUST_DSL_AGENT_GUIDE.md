...
<!-- vocab-structural-sha: f98e81275f078db32e3c93c6cae8639d934d7f5655517583459447e87fb25662 -->
...
Complete, enum-derived index of every authoring primitive: **154 step verbs**, **160 predicates**, **56 timings**, **12 declarative kinds**. `uses` = card YAMLs referencing the key; `tag` flags `unused` (0 uses) or `rare` (1–2) vocabulary; `fixture` is a real card to open.
...
| `place_remainder_on_deck` | `PlaceRemainderArgs` | 64 |  | `_examples/BT9-092.yaml` |  |
...
| key | arg | uses | tag | fixture | description |
|-----|-----|------|-----|---------|-------------|
| `add_to_hand_from_reveal` | `HandleMoveArgs` | 67 |  | `_examples/BT9-092.yaml` |  |
...
| `reveal_top_deck` | `RevealArgs` | 77 |  | `_examples/BT13-007.yaml` |  |
| `select_reveal` | `SelectZoneArgs` | 31 |  | `_examples/BT9-092.yaml` |  |
