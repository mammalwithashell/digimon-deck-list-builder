...
<!-- vocab-structural-sha: 30be9fe9ca95a9227300d1e6187a721f64fbae9e4a7d39e2c4003c1d71cac903 -->
...
Complete, enum-derived index of every authoring primitive: **151 step verbs**, **157 predicates**, **56 timings**, **12 declarative kinds**. `uses` = card YAMLs referencing the key; `tag` flags `unused` (0 uses) or `rare` (1–2) vocabulary; `fixture` is a real card to open.
...
| key | arg | uses | tag | fixture | description |
|-----|-----|------|-----|---------|-------------|
| `gain_memory` | `FormulaSpec` | 91 |  | `_examples/BT11-042.yaml` |  |
| `lose_memory` | `FormulaSpec` | 9 |  | `bt1/BT1-090.yaml` |  |
| `set_memory` | `FormulaSpec` | 19 |  | `bt1/BT1-085.yaml` |  |
