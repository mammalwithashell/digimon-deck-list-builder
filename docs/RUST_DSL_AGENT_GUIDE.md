...
<!-- vocab-structural-sha: 8b08ec9e1286a2e58717c8bd8ca6a8e5a249de38977054f16c4ca2df122783a3 -->
...
Complete, enum-derived index of every authoring primitive: **149 step verbs**, **166 predicates**, **56 timings**, **12 declarative kinds**. `uses` = card YAMLs referencing the key; `tag` flags `unused` (0 uses) or `rare` (1–2) vocabulary; `fixture` is a real card to open.
...
| `may_attack_now` | `MayAttackNowArgs` | 27 |  | `ad1/AD1-004.yaml` |  |
...
| key | arg | uses | tag | fixture | description |
|-----|-----|------|-----|---------|-------------|
| `activation_cost` | `ActivationCostArgs` | 39 |  | `ad1/AD1-019.yaml` |  |
| `for_each` | `ForEachStep` | 34 |  | `_examples/BT13-007.yaml` |  |
| `if` | `IfStep` | 183 |  | `_examples/BT15-003.yaml` |  |
| `optional` | `OptionalStep` | 408 |  | `_examples/BT11-042.yaml` |  |
| `per_selected` | `PerSelectedStep` | 27 |  | `ad1/AD1-014.yaml` |  |
| `place_self_as_delay_option` | `EmptyArgs` | 31 |  | `bt13/BT13-110.yaml` |  |
...
| key | arg | uses | tag | fixture | description |
|-----|-----|------|-----|---------|-------------|
| `effect_initiated_digivolve` | `EffectDigivolveArgs` | 68 |  | `_examples/BT17-015.yaml` |  |
...
| `de_digivolve` | `DeDigivolveArgs` | 30 |  | `ad1/AD1-009.yaml` |  |
| `delete_bound_permanents` | `DeleteBoundPermanentsArgs` | 3 |  | `bt17/BT17-018.yaml` |  |
| `delete_permanent` | `TargetArg` | 115 |  | `_examples/BT17-015.yaml` |  |
| `hatch` | `PlayerArg` | 5 |  | `bt16/BT16-082.yaml` |  |
| `return_to_deck` | `ReturnPermanentArgs` | 28 |  | `_examples/BT12-112.yaml` |  |
| `return_to_hand` | `TargetArg` | 18 |  | `_examples/BT13-060.yaml` |  |
| `suspend` | `TargetArg` | 71 |  | `_examples/BT13-060.yaml` |  |
| `trash_breeding_permanent` | `TrashBreedingPermanentArgs` | 1 | rare | `bt13/BT13-112.yaml` |  |
| `unsuspend` | `TargetArg` | 45 |  | `ad1/AD1-006.yaml` |  |
...
| `add_to_hand_from_trash` | `HandleMoveArgs` | 17 |  | `_examples/BT7-107.yaml` |  |
| `draw` | `DrawArgs` | 93 |  | `_examples/TST_DNA_TRIGGER.yaml` |  |
...
| `recover` | `DrawArgs` | 15 |  | `_examples/BT11-042.yaml` |  |
...
| key | arg | uses | tag | fixture | description |
|-----|-----|------|-----|---------|-------------|
| `gain_memory` | `FormulaSpec` | 99 |  | `_examples/BT11-042.yaml` |  |
| `lose_memory` | `FormulaSpec` | 9 |  | `bt1/BT1-090.yaml` |  |
| `set_memory` | `FormulaSpec` | 20 |  | `bt1/BT1-085.yaml` |  |

#### Modifier / Keyword — 8 (0 unused)

| key | arg | uses | tag | fixture | description |
|-----|-----|------|-----|---------|-------------|
| `add_dp_modifier` | `AddDpModifierArgs` | 78 |  | `ad1/AD1-016.yaml` |  |
| `add_modifier` | `AddModifierArgs` | 63 |  | `_examples/BT13-060.yaml` |  |
| `add_player_modifier` | `AddPlayerModifierArgs` | 8 |  | `bt15/BT15-092.yaml` |  |
...
| `grant_effect_immunity` | `GrantEffectImmunityArgs` | 15 |  | `ad1/AD1-009.yaml` |  |
| `grant_keyword` | `GrantKeywordArgs` | 65 |  | `_examples/BT11-042.yaml` |  |
...
| key | arg | uses | tag | fixture | description |
|-----|-----|------|-----|---------|-------------|
| `add_this_option_to_hand` | `EmptyArgs` | 19 |  | `_examples/BT7-107.yaml` |  |
...
| `place_remainder_on_deck` | `PlaceRemainderArgs` | 63 |  | `_examples/BT9-092.yaml` |  |
...
#### Play / zone-in — 9 (1 unused)

| key | arg | uses | tag | fixture | description |
|-----|-----|------|-----|---------|-------------|
| `play_from_hand` | `PlayFromHandArgs` | 13 |  | `ad1/AD1-019.yaml` |  |
| `play_from_hand_free` | `PlayFromHandFreeArgs` | 61 |  | `bt13/BT13-020.yaml` |  |
...
| `play_union_bound_free` | `PlayUnionBoundFreeArgs` | 25 |  | `ad1/AD1-002.yaml` | PUPPETS-G014 â€” play a `select_union_zone`-bound card for free from its true origin zone (hand, trash, or material), recovered from the binding. |
...
| key | arg | uses | tag | fixture | description |
|-----|-----|------|-----|---------|-------------|
| `add_to_hand_from_reveal` | `HandleMoveArgs` | 66 |  | `_examples/BT9-092.yaml` |  |
...
| `reveal_top_deck` | `RevealArgs` | 76 |  | `_examples/BT13-007.yaml` |  |
| `select_reveal` | `SelectZoneArgs` | 30 |  | `_examples/BT9-092.yaml` |  |
| `select_reveal_buckets` | `SelectRevealBucketsArgs` | 41 |  | `bt12/BT12-021.yaml` |  |
...
| `add_top_security_to_hand` | `PlayerArg` | 10 |  | `bt11/BT11-033.yaml` |  |
...
| `place_on_security` | `PlaceOnSecurityArgs` | 23 |  | `_examples/BT18-102.yaml` |  |
| `play_from_security` | `PlayFromSecurityArgs` | 89 |  | `_examples/BT9-092.yaml` |  |
...
| `trash_top_security` | `TrashTopSecurityArgs` | 44 |  | `_examples/BT15-003.yaml` |  |
...
| `select_count_capped_multi` | `SelectCountCappedArgs` | 22 |  | `_examples/BT18-019.yaml` |  |
| `select_dna_pair` | `SelectDnaPairArgs` | 5 |  | `ad1/AD1-009.yaml` |  |
| `select_effect_choice` | `SelectEffectChoiceArgs` | 58 |  | `_examples/BT15-003.yaml` |  |
| `select_hand` | `SelectZoneArgs` | 184 |  | `_examples/BT17-015.yaml` |  |
...
| `select_opponent_permanent` | `SelectFieldArgs` | 223 |  | `_examples/BT12-112.yaml` |  |
...
| `select_own_permanent` | `SelectFieldArgs` | 148 |  | `_examples/BT12-112.yaml` |  |
| `select_trash` | `SelectZoneArgs` | 68 |  | `_examples/BT18-019.yaml` |  |
| `select_union_zone` | `SelectUnionArgs` | 37 |  | `ad1/AD1-002.yaml` |  |

#### Stack / Source — 14 (0 unused)

| key | arg | uses | tag | fixture | description |
|-----|-----|------|-----|---------|-------------|
| `place_as_bottom_source` | `PlaceAsBottomSourceArgs` | 41 |  | `_examples/BT13-007.yaml` |  |
...
#### Aggregate / existential — 13 (2 unused)

| key | arg | uses | tag | fixture | description |
|-----|-----|------|-----|---------|-------------|
| `all_permanents` | `ExistentialPredicate?` | 0 | unused | — |  |
| `any_field_permanent` | `ExistentialPredicate?` | 22 |  | `bt21/BT21-093.yaml` |  |
| `any_permanent` | `ExistentialPredicate?` | 172 |  | `_examples/BT11-042.yaml` |  |
| `color_matches_any_field_digimon` | `PlayerRefSelector?` | 1 | rare | `p/P-206.yaml` |  |
| `count_gte` | `CountAggregate?` | 78 |  | `_examples/EX11-027.yaml` |  |
| `count_lte` | `CountAggregate?` | 21 |  | `bt13/BT13-111.yaml` |  |
| `has_alt_path` | `str?` | 4 |  | `bt10/BT10-087.yaml` |  |
| `level_matches_aggregate` | `LevelAggregatePredicate?` | 8 |  | `ad1/AD1-012.yaml` |  |
...
| key | arg | uses | tag | fixture | description |
|-----|-----|------|-----|---------|-------------|
| `all_of` | `[PredicateSpec]` | 475 |  | `_examples/BT11-042.yaml` |  |
| `any_of` | `[PredicateSpec]` | 276 |  | `_examples/BT11-042.yaml` |  |
| `none_of` | `[PredicateSpec]` | 26 |  | `bt13/BT13-019.yaml` |  |
| `not` | `PredicateSpec?` | 7 |  | `ad1/AD1-017.yaml` |  |
| `other` | `bool?` | 22 |  | `ad1/AD1-012.yaml` |  |
| `owner` | `PlayerRef?` | 49 |  | `_examples/BT11-042.yaml` |  |
| `zone` | `[Zone]` | 308 |  | `_examples/BT11-042.yaml` |  |

#### Context / global — 22 (6 unused)

| key | arg | uses | tag | fixture | description |
|-----|-----|------|-----|---------|-------------|
| `all_turns` | `bool?` | 113 |  | `ad1/AD1-001.yaml` |  |
...
| `memory_lte` | `DpConstraint?` | 29 |  | `bt1/BT1-085.yaml` |  |
...
| `security_count` | `MetricComparators?` | 0 | unused | — |  |
| `security_count_gte` | `DpConstraint?` | 17 |  | `_examples/BT15-003.yaml` |  |
...
| `event_host_permanent_is_source` | `bool?` | 5 |  | `ex11/EX11-044.yaml` | True when the triggering event's host permanent is this effect's source permanent. Used by OnDigivolutionCardTrashed observers that care about "this Digimon's digivolution cards" rather than any own stack. |
| `event_is_effect_initiated` | `bool?` | 12 |  | `ad1/AD1-024.yaml` |  |
| `event_permanent_is_source` | `bool?` | 23 |  | `ad1/AD1-021.yaml` |  |
...
| `event_target_kind` | `CardKind?` | 67 |  | `ad1/AD1-014.yaml` |  |
...
| `event_target_owner` | `PlayerRef?` | 99 |  | `_examples/BT11-042.yaml` |  |
...
| `card_number_is` | `str?` | 49 |  | `bt17/BT17-093.yaml` |  |
| `color_is` | `ColorSpec?` | 333 |  | `_examples/BT11-042.yaml` |  |
...
| `play_cost_lte` | `DpConstraint?` | 38 |  | `ad1/AD1-018.yaml` |  |
...
| `trait_has` | `str?` | 352 |  | `_examples/BT11-042.yaml` |  |
...
| `replacement_subject_is_mine` | `bool?` | 28 |  | `bt13/BT13-075.yaml` |  |

#### Source-relative — 14 (3 unused)
...
| `end_of_opponents_turn` | 102 |  |
| `end_of_your_next_turn` | 12 |  |
| `end_of_your_turn` | 31 |  |
| `main` | 33 |  |
| `main_from_hand` | 97 |  |
| `main_from_trash` | 0 |  |
...
| `on_deletion` | 39 |  |
| `on_digivolution_card_trashed` | 23 |  |
| `on_digivolve` | 35 |  |
| `on_digixros` | 0 |  |
...
| `start_of_your_main_phase` | 55 |  |
| `start_of_your_turn` | 30 |  |
